...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Null Bot', body: wm, sourceUrl: 'https://wa.me/6289504575881?text=hallo+kakak+saya+mau+order+jadi+owner+bot', thumbnail: data }}, options })
    }
